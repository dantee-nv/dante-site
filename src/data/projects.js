...
const baseProjects = [
  ...
  },
  {
    ...
    status: "live",
    tags: ["website", "portfolio", "personal site", "React", "Vite", "AWS Amplify"],
    atGlance: {
      skills: [
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body:
          "The panel is designed around a coding-practice flow where users keep one challenge in focus while iterating with the assistant.",
        bullets: [
